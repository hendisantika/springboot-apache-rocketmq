package com.hendisantika.springbootapacherocketmq;
...
public class SpringbootApacheRocketmqApplication implements CommandLineRunner {

    @Autowired
    private RocketMQTemplate rocketMQTemplate;

    public static void main(String[] args) {
        SpringApplication.run(SpringbootApacheRocketmqApplication.class, args);
    }
